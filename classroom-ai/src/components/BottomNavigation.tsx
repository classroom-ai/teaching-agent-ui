...
export default function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-200 shadow-lg z-50">
      <div className="flex justify-around items-center h-[7.5vh] px-4">
